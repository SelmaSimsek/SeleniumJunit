...
public class C04_TimeOutException extends TestBase {
    ...
    implicitwait te süre süre yeterli olmazsa NoSuchElementException aliriz

    Eger TimeOutException aliyorsak
    1- Explicit wait te kullandigimiz maximum süreyi kontrol etmeliyiz
    1- Explicit wait te almis oldugumuz locate i kontrol etmeliyiz
    1- Explicit wait te kullandigimiz methodu kontrol etmeliyiz
    1- Explicit wait te locate ini aldigimiz webelement iframe icinde olabilir, dolayisiyla
