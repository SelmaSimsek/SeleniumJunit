...
public class C04_JsExecutorLocate extends TestBase {
    ...
    public void test01() {
        ...
        WebElement helloShadowDomWe = (WebElement) js.executeScript
                ("return document.getElementById('content')");
        System.out.println("helloShadowDomWe = " + helloShadowDomWe.getText());

        Assert.assertEquals("Hello Shadow DOM" ,helloShadowDomWe);
    ...
    public void amazonTest() {
        ...
        JavascriptExecutor js = (JavascriptExecutor) driver;
        String searchBoxValue = js.executeScript
        ...
        String typeAttributeDegeri = js.executeScript
                        ("return document.getElementById('twotabsearchtextbox').type").
                toString();
        System.out.println(typeAttributeDegeri);



        String nameAttributeDegeri = js.executeScript
                        ("return document.getElementById('twotabsearchtextbox').name").
                toString();
        ...
        String classAttributeDegeri = js.executeScript
                        ("return document.getElementById('twotabsearchtextbox').className").
                toString();
