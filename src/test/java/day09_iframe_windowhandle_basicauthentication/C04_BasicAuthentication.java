...
public class C04_BasicAuthentication extends TestBase {
    ...
    public void test01() {
        ...
        String expectedText = "You must have the proper credentials";
        Assert.assertEquals(expectedText,actualText);

        //Elemental Selenium linkine tıklayınız
        driver.findElement(By.xpath("(//a)[2]")).click();
        window(1); //TestBase clasinda olusturdugumuz window methodu ile yeni acilan sayfaya
        //kolaylikla gecebildik
