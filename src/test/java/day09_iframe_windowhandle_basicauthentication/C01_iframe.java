...
public class C01_iframe extends TestBase {
    ...
    public void test01() {
        ...
        //driver.navigate().refresh(); //ana sayfaya bu da döner. refresh yapilinca frame icinde yapilan
        // degisiklikler eski haline döner
        //driver.get(driver.getCurrentUrl());  //bu da refresh yapar

        WebElement elementalSelenium = driver.findElement
                (By.xpath("//a [.='Elemental Selenium']"));
