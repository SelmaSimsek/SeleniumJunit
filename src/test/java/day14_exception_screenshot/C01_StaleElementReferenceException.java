...
public class C01_StaleElementReferenceException extends TestBase {
    ...
    Bir sayfadaki bir webelementi locake ettikten ve bunu bir webelemet seklinde
    store ettikten sonra o sayfada herhangi bir yenileme islemi yapildiginda
    (navigate.refresh(), back(), forward()) locate ini aldigimiz webelementi tekrar
    kullanmak istersek bu eception i aliriz.

    Bu hatayi nasil handle ederiz?
    Bu exceptionn i handle edebilmek icin elementin locate ini refresh(), back(),
    forward() gibi methodlar kullandiktan sonra tekrar almamiz gerekir.
    ...
    ==> InvalidArgumentException -> BAkiniz test3. gecersiz datanin methoda gönderilmesi
