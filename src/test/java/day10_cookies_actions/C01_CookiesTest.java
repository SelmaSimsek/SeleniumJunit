    ...
    */
    ...
    public void test01() {
        ...
        for (Cookie w : cookieSet) {
            System.out.println(counter + " . cookies  ==> " + w);
            System.out.println(counter + " . cookies Name ==> " + w.getName());
            System.out.println(counter + " . cookies Value ==> " + w.getValue());
        ...
        int counter1 = 1;
        for (Cookie w : cookieSet) {
            System.out.println(counter1 + " . cookies  ==> " + w);
            System.out.println(counter1 + " . cookies Name ==> " + w.getName());
            System.out.println(counter1 + " . cookies Value ==> " + w.getValue());
        ...
        int counter2 = 1;
        for (Cookie w : cookieSet) {
            System.out.println(counter2 + " . cookies  ==> " + w);
            System.out.println(counter2 + " . cookies Name ==> " + w.getName());
            System.out.println(counter2 + " . cookies Value ==> " + w.getValue());
